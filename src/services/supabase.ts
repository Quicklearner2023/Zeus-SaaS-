...
-- Allow Anon & Authenticated Read/Write for SaaS Orchestrator Ops
...
CREATE POLICY "Allow anon read agent_tasks" ON public.agent_tasks FOR SELECT USING (true);
CREATE POLICY "Allow anon insert agent_tasks" ON public.agent_tasks FOR INSERT WITH CHECK (true);
`;
