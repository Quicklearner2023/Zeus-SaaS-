        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-black/[0.04] pb-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500">The production service-role credential stays on the server. This panel only accepts the public project URL and anon key.</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input 
              ...
              className="w-full px-3.5 py-2 pr-10 rounded-xl border border-black/[0.08] text-xs font-mono focus:outline-none focus:ring-2 focus:ring-emerald-500/20 bg-zinc-50/80"
            />
            <button type="button" onClick={() => setShowAnonKey(v => !v)} className="mt-[-30px] mr-2 ml-auto relative block text-zinc-400 hover:text-zinc-700" aria-label={showAnonKey ? 'Hide key' : 'Show key'}>
